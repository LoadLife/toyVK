...
private:
    ...
    static void setupDebugMessenger(){
        ...
        {
            cerr<<"failed to set up debug messenger"<<endl;
            exit(EXIT_FAILURE);
        }
   }
    ...
    static void createCommandBuffers()
    {
        ...
        if (vkAllocateCommandBuffers(device, &allocInfo, commandBuffers.data()) != VK_SUCCESS) {
            cerr<<"failed to allocate command buffers"<<endl;
            exit(EXIT_FAILURE);
        }
    ...
    static void createGraphicsPipeline()
    {
        ...
        {
              cerr<<"failed to create pipeline layout"<<endl;
              exit(EXIT_FAILURE);
        }
        ...
        {
            cerr<<"failed to find GPUs create grphics pipeline"<<endl;
            exit(EXIT_FAILURE);
        }
    ...
    static VkShaderModule createShaderModule(const vector<char>& code)
    {
    ...
    static void createSyncObjects()
    {
        ...
        for (size_t i = 0; i < MAX_FRAMES_IN_FLIGHT; i++) 
        {
            ...
            {
                cerr<<"failed to crete synchronization objects for a frame"<<endl;
                exit(EXIT_FAILURE);
            }
        }
    }
    ...
    static void createImageViews()
    {
        ...
        for (size_t i = 0; i < swapChainImages.size(); i++) {
            ...
            {
                cerr<<"failed to create image views"<<endl;
                exit(EXIT_FAILURE);
            }
        }
    }
    ...
    static vector<VkFramebuffer> swapChainFramebuffers;
...
VkSwapchainKHR Entrance::swapChain;
vector<VkImage> Entrance::swapChainImages;
VkFormat Entrance::swapChainImageFormat;
VkExtent2D Entrance::swapChainExtent;
vector<VkImageView> Entrance::swapChainImageViews;
VkPipelineLayout Entrance::pipelineLayout;
VkRenderPass Entrance::renderPass;
VkPipeline Entrance::graphicsPipeline;
vector<VkFramebuffer> Entrance::swapChainFramebuffers;
VkCommandPool Entrance::commandPool;
vector<VkCommandBuffer> Entrance::commandBuffers;
vector<VkSemaphore> Entrance::imageAvailableSemaphores;
vector<VkSemaphore> Entrance::renderFinishedSemaphores;
vector<VkFence> Entrance::inFlightFences;
vector<VkFence> Entrance::imagesInFlight;
size_t Entrance::currentFrame = 0;
